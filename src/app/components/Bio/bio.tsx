    ...
    return (
        <div className={styles.section}>
            <div className={styles.picture}>
                <Image src="/oscarHeadPic.png" alt="Oscar Jimenez" className={styles.oscarImg} width={200} height={200} />
            ...
            <div className={styles.about}>
                <h3>Who am I?</h3>
                <p>Hi! My name is Oscar, a Software Engineer based in California. I have experience in building full-stack projects from concept to production with a strong focus on front-end technologies.</p>
